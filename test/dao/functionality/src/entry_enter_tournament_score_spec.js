...
describe("Enter a tournament score for an entry", function () {
    ...
    post("Non-playing user", "charlie_murphy", null, 5,
        403, "Permission denied");
    post("Different entry", p2, null, 5, 403, "Permission denied");
    post("Superuser", "superuser",
        "enter_score_test_per_tourn_su", 5, 200,
        "Score entered for enter_score_test_p_1: 5");
    post("TO", "enter_score_test_to",
        "enter_score_test_per_tourn_to", 5, 200,
        "Score entered for enter_score_test_p_1: 5");
    post("Player", p1, null, 5, 200,
        "Score entered for enter_score_test_p_1: 5");
    ...
    post("Fake category", p1, "non_existent",
        5, 400, "Unknown category: non_existent");
    post("Per game category", p1, "enter_score_test_per_game_1",
        5, 400, "enter_score_test_per_game_1 should be " +
